 ...
 */
class FragmentBK : Fragment(), View.OnClickListener {
    ...
    fun initUI() {
        ...
        myGrad5.setStroke(1, resources.getColor(R.color.colorPrimary))
        myGrad5.setColor(resources.getColor(R.color.colorPrimary))
        ...
        myGrad2.setColor(resources.getColor(R.color.colorPrimary))
        tv6!!.background = myGrad2

        var myGrad3 = GradientDrawable()
        myGrad3.setStroke(1, resources.getColor(R.color.colorPrimary))
        myGrad3.cornerRadius = 80.0f
        myGrad3.setColor(resources.getColor(R.color.colorPrimary))
//        tv4!!.background = BitmapUtil.addStateDrawable2(context, myGrad3, R.drawable.drawable_test1, R.drawable.drawable_test1, R.drawable.drawable_test1)
        ...
        myGrad4.setStroke(1, resources.getColor(R.color.colorPrimary))
        ...
        plabit = BitmapUtil.tintBitmap(plabit, resources.getColor(R.color.colorPrimary))
        iv2!!.setImageDrawable(BitmapDrawable(plabit))
        iv3!!.setImageDrawable(BitmapDrawable(plabit))
    }
